...
import { CheckCircle2, GitPullRequest, Shield, BarChart3, ExternalLink, ArrowRight } from "lucide-react";
        ...
        <div className="space-y-3 text-left">
          ...
          <Card>
            <CardContent className="flex gap-4 py-4">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 dark:text-gray-100">Open a Pull Request</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Push a branch and open a PR. Inkog will automatically run a security scan and post results as a check run and PR comment.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="flex gap-4 py-4">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 dark:text-gray-100">Review Findings</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  If issues are found, they appear inline on the PR with severity, file location, and remediation guidance.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="flex gap-4 py-4">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 dark:text-gray-100">Track in Dashboard</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  View scan history, trends, and compliance reports across all your repositories.
                </p>
              </div>
            </CardContent>
          </Card>
